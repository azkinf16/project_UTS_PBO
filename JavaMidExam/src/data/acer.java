...
public class acer extends Laptop{
    ...
    private byte procCore = 0, RAM = 0, stok = 0;
    private double screenSize = 0, weight = 0;
    
    Scanner scanner = new Scanner(System.in);
    
    public acer (String name, String brand){
        super(name, brand);
    }
    
    public acer (String name, String brand, String procName, 
    ...
    public void setStorfronePosition(String storage){
        if (null == storage){
            System.out.println("TIdak Ada Penyimpanan");
        } else switch (storage) {
            case "SSD M.2":
